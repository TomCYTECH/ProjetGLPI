...
BEGIN
  FOR i IN 1..100000 LOOP
    ...
    VALUES (TRUNC(DBMS_RANDOM.VALUE(1, 5)), 'Site_' || i);
  END LOOP;
  COMMIT;
END;
/
...
BEGIN
  FOR i IN 1..100000 LOOP
    ...
    VALUES ('Ticket'||i, TRUNC(DBMS_RANDOM.VALUE(1, 100001)), random_date(TO_DATE('2020-01-01', 'YYYY-MM-DD'), TO_DATE('2022-12-31', 'YYYY-MM-DD')), TRUNC(DBMS_RANDOM.VALUE(1, 100001)), 'Description'||i, TRUNC(DBMS_RANDOM.VALUE(1, 3)), 
    CASE TRUNC(DBMS_RANDOM.VALUE(1, 4))
...
BEGIN
  FOR i IN 1..100000 LOOP
    ...
    VALUES (i, TRUNC(DBMS_RANDOM.VALUE(1, 100001)), v_start_date, v_end_date);
  END LOOP;
  COMMIT;
END;
/