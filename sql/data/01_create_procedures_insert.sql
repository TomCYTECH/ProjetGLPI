...
BEGIN
  FOR i IN 1..10000 LOOP
    INSERT INTO GLPI_EQUIPEMENT (NOM, TYPE_ID, LIEU_ID, SITE_ID)
    VALUES ('Equipement' || i, TRUNC(DBMS_RANDOM.VALUE(1, 4)), TRUNC(DBMS_RANDOM.VALUE(1, 6)), TRUNC(DBMS_RANDOM.VALUE(1, 3)));
  END LOOP;
  COMMIT;
END;
/
